...
var MainNetParams = Params{
	...
	// Address encoding magics
	PubKeyHashAddrID:        []byte{0x1C,0xB8}, // starts with 1
	ScriptHashAddrID:        []byte{0x1C,0xBD}, // starts with 3
...
var TestNet3Params = Params{
	...
	// Address encoding magics
	PubKeyHashAddrID:        []byte{0x1D,0x25}, // starts with m or n
	ScriptHashAddrID:        []byte{0x1C,0xBA}, // starts with 2
...
func Register(params *Params) error {
	...
	pubKeyHashAddrIDs[string(params.PubKeyHashAddrID)] = struct{}{}
	scriptHashAddrIDs[string(params.ScriptHashAddrID)] = struct{}{}
