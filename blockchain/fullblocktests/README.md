...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/rhaps107/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/rhaps107/btcd/blockchain/fullblocktests
```
