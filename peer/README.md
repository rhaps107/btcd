...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/rhaps107/btcd/peer)
...
```bash
$ go get -u github.com/rhaps107/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/rhaps107/btcd/peer#example-package--NewOutboundPeer)
