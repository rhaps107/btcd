...
* Unlike bitcoind that has the wallet and chain intermingled in the same process
  ...
  [btcwallet](https://github.com/rhaps107/btcwallet).
...
such as [btcwallet](https://github.com/rhaps107/btcwallet) for inter-process
...
[btcrpcclient](https://github.com/rhaps107/btcrpcclient) package.
...
[btcrpcclient](https://github.com/rhaps107/btcrpcclient) package to connect with
...
import (
	"github.com/rhaps107/btcrpcclient"
